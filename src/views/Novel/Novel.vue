<template>
  <div id="novel" v-if="rollArr.length !== 0">
    <NovelBackBar />
    <NovelHeader :id="novelInfo.id" :name="novelInfo.name" :author="novelInfo.author" :class-name="novelInfo.className"
      :is-animation="novelInfo.isAnimation" :is-serial="novelInfo.isSerial" :pic-url="novelInfo.picUrl" />
    <NovelInfo :word-count="novelInfo.wordCount" :collect="novelInfo.collect" :updateTime="novelInfo.updateTime"
      :recentChapters="novelInfo.recentChapters" :classTags="novelInfo.classTags" :intro="novelInfo.intro"
      @on-link="newestLink" />
    <NovelDirectory :recent-chapters="novelInfo.recentChapters" :roll-arr="rollArr" />
    <NovelComment :id="ids" />
    <NovelBtn :id="ids" :chapter_id="rollArr[0].chapter_list[0].id" />
  </div>
</template>
