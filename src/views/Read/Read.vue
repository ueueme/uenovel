<template>
  <div id="read" @click="onShowSidebar" :style="{ backgroundColor: color }">
    <ReadSidebar @onChangeColor="changeBackground" @onShowDirectory="onShowDirectory" :chapter-ids="chapterIds"
      :chapter-title="chapterTitle" :novel-id="novelId" v-if="isLoading" ref="readSidebar">
    </ReadSidebar>
    <ReadContent :chapter-content="chapterContent" :chapter-title="chapterTitle" :novel-id="novelId"
