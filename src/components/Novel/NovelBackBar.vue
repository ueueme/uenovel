    ...
    <var-app-bar :color="isTabColor ? '#fff' : 'transparent'" elevation="0">
      <template #left>
        <var-button color="transparent" text-color="#fff" round text @click="onBack">
          <arrow-left theme="outline" size="0.35rem" :fill="isTabColor ? '#000' : '#fff'" strokeLinejoin="bevel"
            strokeLinecap="square" />
        </var-button>
      </template>
      <template #right>
        <var-button color="transparent" text-color="#fff" round text @click="onLink">
          <home theme="outline" size="0.35rem" :fill="isTabColor ? '#000' : '#fff'" strokeLinejoin="bevel"
            strokeLinecap="square" />
        </var-button>
      </template>
    </var-app-bar>
