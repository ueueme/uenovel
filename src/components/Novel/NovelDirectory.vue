      ...
      <div class="novel-directory-popup">
        <div class="novel-directory-back">
          <var-app-bar color="#fff" text-color="#000" elevation="0" title="目录" title-position="center">
            <template #left>
              <var-button color="transparent" text-color="#000" round text @click="isPopup = false">
        ...
        <div class="novel-directory-list">
          <NovelDirectoryItem :name="item.roll_title" :roll-chapter-list="item.chapter_list" v-for="item in rollArr">
          </NovelDirectoryItem>
        </div>
      </div>
