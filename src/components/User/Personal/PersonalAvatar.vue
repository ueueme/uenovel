<template>
  <div class="personal-avatar-item">
    ...
    <var-dialog title="昵称修改" v-model:show="show" confirm-button-text-color="#ff3992" cancel-button-text-color="#ff3992"
      @confirm="onChangeAvatar" :close-on-click-overlay="false">
      <div class="personal-dialog">
        <var-uploader v-model="files" :maxlength="1" :maxsize="1024 * 1024 * 2" @oversize="uploadInfo" />
...
async function onChangeAvatar() {
  ...
  else if (files.value.length > 0) return Snackbar.error('腾讯COS过期')
